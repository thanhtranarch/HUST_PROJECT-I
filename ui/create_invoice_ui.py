...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.invoice_information.setGeometry(QRect(10, 50, 341, 141))
        self.label = QLabel(self.invoice_information)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 20, 71, 21))
        self.label_2 = QLabel(self.invoice_information)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 50, 71, 21))
        self.label_4 = QLabel(self.invoice_information)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(10, 80, 81, 21))
        self.label_5 = QLabel(self.invoice_information)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(10, 110, 81, 21))
        self.invoice_id = QLineEdit(self.invoice_information)
        self.invoice_id.setObjectName(u"invoice_id")
        self.invoice_id.setGeometry(QRect(90, 20, 241, 20))
        self.invoice_date = QDateEdit(self.invoice_information)
        self.invoice_date.setObjectName(u"invoice_date")
        self.invoice_date.setGeometry(QRect(90, 50, 241, 22))
        ...
        self.customer_phone = QLineEdit(self.invoice_information)
        self.customer_phone.setObjectName(u"customer_phone")
        self.customer_phone.setGeometry(QRect(90, 110, 241, 20))
        self.label_3 = QLabel(Dialog)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 20, 731, 20))
        font = QFont()
        ...
        self.list_medicine.setGeometry(QRect(10, 211, 741, 251))
        ...
        self.add_medicine_2.setGeometry(QRect(360, 160, 101, 23))
        self.groupBox = QGroupBox(Dialog)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 470, 741, 41))
        self.sum = QLabel(self.groupBox)
        self.sum.setObjectName(u"sum")
        self.sum.setGeometry(QRect(10, 10, 61, 21))
        self.coupon = QLabel(self.groupBox)
        self.coupon.setObjectName(u"coupon")
        self.coupon.setGeometry(QRect(350, 10, 61, 21))
        ...
        self.sum_money_2 = QLineEdit(self.groupBox)
        self.sum_money_2.setObjectName(u"sum_money_2")
        self.sum_money_2.setGeometry(QRect(400, 10, 113, 20))
        ...
        self.save_button.setGeometry(QRect(300, 530, 75, 23))
        self.cancel_button = QPushButton(Dialog)
        self.cancel_button.setObjectName(u"cancel_button")
        self.cancel_button.setGeometry(QRect(390, 530, 75, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.invoice_information.setTitle(QCoreApplication.translate("Dialog", u"TH\u00d4NG TIN H\u00d3A \u0110\u01a0N", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"M\u00e3 h\u00f3a \u0111\u01a1n", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Ng\u00e0y l\u1eadp", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"Nh\u00e2n vi\u00ean", None))
        self.label_5.setText(QCoreApplication.translate("Dialog", u"Kh\u00e1ch h\u00e0ng", None))
        self.label_3.setText(QCoreApplication.translate("Dialog", u"H\u00d3A \u0110\u01a0N", None))
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Dialog", u"S\u1ed1 l\u01b0\u1ee3ng c\u00f2n", None));
        ___qtablewidgetitem4 = self.buy_list.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Dialog", u"S\u1ed1 l\u01b0\u1ee3ng", None));
        ___qtablewidgetitem5 = self.buy_list.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Dialog", u"Th\u00e0nh ti\u1ec1n", None));
        ...
        self.add_medicine_2.setText(QCoreApplication.translate("Dialog", u"Th\u00eam kh\u00e1ch h\u00e0ng", None))
        self.groupBox.setTitle("")
        self.sum.setText(QCoreApplication.translate("Dialog", u"T\u1ed5ng ti\u1ec1n:", None))
        self.coupon.setText(QCoreApplication.translate("Dialog", u"Gi\u1ea3m gi\u00e1:", None))
        self.payment.setText(QCoreApplication.translate("Dialog", u"Thanh to\u00e1n:", None))
        self.sum_money_2.setText("")
