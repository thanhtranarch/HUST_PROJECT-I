...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.invoice_daily.setTitle(QCoreApplication.translate("MainWindow", u"DANH S\u00c1CH NH\u00c2N VI\u00caN", None))
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Created Time", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Updated Time", None));
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Details", None));
